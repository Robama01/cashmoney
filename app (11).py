...
def init_db():
    ...
    migration_columns = [
        ...
        ("users", "facebook_link", "TEXT"),
        ("users", "is_premium", "BOOLEAN DEFAULT FALSE"),
        ("users", "balance", "NUMERIC DEFAULT 0"),
    ...
    migrations = [
        ...
        ("videos", "premium_only", "BOOLEAN DEFAULT FALSE"),
        ("videos", "remaining_budget", "NUMERIC DEFAULT 0"),
        ("videos", "maintenance_fee", "NUMERIC DEFAULT 0"),
        ("videos", "investment_amount", "NUMERIC DEFAULT 0"),
        ("watch_logs", "ip_address", "TEXT"),
        ("watch_logs", "user_agent", "TEXT"),
        ("payouts", "error_message", "TEXT"),
        ("payouts", "retry_count", "INTEGER DEFAULT 0"),
        ("payouts", "tx_hash", "TEXT"),
    ]
