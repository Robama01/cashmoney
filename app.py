...
def init_db():
    ...
    with get_db() as conn:
        ...
        # Table users (avec les nouvelles colonnes)
...
@app.route("/admin")
def admin():
    # Vous pouvez remplacer par votre propre page admin
...
def test_pay(uid):
    ...
    # Sécurité : seul l'admin ou l'utilisateur lui-même peut tester ?
    # Ici on permet à tous les connectés (à adapter)
