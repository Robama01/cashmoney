...
<p style="text-align:center;margin-top:1rem;color:#888;font-size:.9rem">Mot de passe oublié ? Contacte le support.</p>
</div></div>
<script>
...
def add_video():
    ...
    cur = conn.cursor()
    cur.execute(
        """INSERT INTO videos (youtube_id, title, sponsor_name, reward_amount, min_watch_seconds, investment_amount, maintenance_fee, remaining_budget, premium_only)
